...
@section('pageTitle',trans('Create Customer Review'))
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" enctype="multipart/form-data" action="{{route(currentUser().'.review.store')}}">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-8 offset-2">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="review" id="review"  rows="2">{{old('review')}}</textarea>
